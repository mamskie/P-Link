@if ($errors->any())
    <div x-data="{ showNotification: true }">
        <div x-show="showNotification" role="alert"
            ...
            <span x-on:click="showNotification = false"
                class="absolute top-0 right-0 mt-2 mr-2 cursor-pointer hover:bg-gray-100 px-1 rounded-sm">
...
@elseif (session('flash_success'))
    <div x-data="{ showNotification: true }">
        <div x-show="showNotification" role="alert"
            class="card relative mb-4 scroll-mt-7 py-3.5 pl-6.5 pr-4 dark:shadow-xs shadow-green-600">
